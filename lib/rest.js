...
Rest_doc_api.prototype.getColumnsObjectBatch = function(columns, values, primary) {
...
Rest_doc_api.prototype.methodPostBatch = function(config, primary, columns) { 
  ...
  self.app.post(url, function(req, res){ 
    ...
    var params = self.getColumnsObjectBatch(columns, req.body, null);
    // console.log(params)
