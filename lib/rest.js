...
Rest_doc_api.prototype.printRoutes = function(api){
  ...
  var self = this;
  self.pages = api.pages || Config_API.PAGES;
...
Rest_doc_api.prototype.build = function(config) {
    ...
    if (config.methods.indexOf('GET') >= 0) {
      ...
      self.methodGetAll(config, primary, columns, hidden);

      self.methodGetById(config, primary, columns, hidden);
    ...
    if (config.methods.indexOf('SEARCH') >= 0) {
      ...
      self.methodSearch(config, primary, columns, hidden);      
    ...
    if (config.methods.indexOf('SEARCH_COLUMN') >= 0) {
      ...
      self.methodSearchColumn(config, primary, columns, hidden);      
    ...
    if (config.methods.indexOf('POST_BATCH') >= 0) {
      ...
      self.methodPostBatch(config, primary, columns);
    ...
    if (config.methods.indexOf('PUT_BATCH') >= 0) {
      ...
      self.methodPutBatch(config, primary, columns);
    ...
    if (config.methods.indexOf('PATCH') >= 0) {
      ...
      self.methodPatch(config, primary, columns);
    ...
    if (config.methods.indexOf('PATCH_BATCH') >= 0) {
      ...
      self.methodPatchBatch(config, primary, columns);
    ...
    if (config.methods.indexOf('DELETE_BATCH') >= 0) {
      ...
      self.methodDeleteBatch(config, primary, columns);
...
Rest_doc_api.prototype.methodGetAll = function(config, primary, columns, hidden) {
...
Rest_doc_api.prototype.methodGetById = function(config, primary, columns, hidden) {
...
Rest_doc_api.prototype.methodSearch = function(config, primary, columns, hidden) {
...
Rest_doc_api.prototype.methodSearchColumn = function(config, primary, columns, hidden) {
...
Rest_doc_api.prototype.methodPostBatch = function(config, primary, columns) { 
...
Rest_doc_api.prototype.methodPutBatch = function(config, primary, columns) { 
...
Rest_doc_api.prototype.methodPatch = function(config, primary, columns) { 
...
Rest_doc_api.prototype.methodPatchBatch = function(config, primary, columns) { 
...
Rest_doc_api.prototype.methodDeleteBatch = function(config, primary, columns) { 
